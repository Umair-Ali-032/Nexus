...
export const InvestorDashboard: React.FC = () => {
  ...
  const steps = [
    {
      target: '.view-startups-btn',
      content: 'Click here to view all startups',
    },
    {
      target: '.search-bar',
      content: 'Search startups using this bar',
    },
    {
      target: '.stats-section',
      content: 'These cards show platform statistics',
    },
    {
      target: '.featured-startups',
      content: 'Here you can see featured startups',
    },
  ];
    ...
    <>
      ...
      <div className="space-y-6 animate-fade-in">
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
          ...
          <Link to="/entrepreneurs" className="view-startups-btn">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="w-full md:w-2/3 search-bar">
            <Input
        ...
        {/* Stats summary */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 stats-section">
