...
export const EntrepreneurDashboard: React.FC = () => {
  ...
  // ✅ Joyride steps
  const steps = [
    { target: '.find-investors-btn', content: 'Click here to find investors for your startup' },
    { target: '.summary-cards', content: 'Here you can see your startup statistics' },
    { target: '.collab-requests', content: 'This section shows collaboration requests' },
    { target: '.recommended-investors', content: 'Recommended investors are shown here' },
  ];
  ...
  return (
    <>
      {/* ✅ Joyride Component */}
      <Joyride steps={steps} run={runTour} continuous />
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        {/* Summary cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 summary-cards">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-4 collab-requests">
            <Card>
          ...
          <div className="space-y-4 recommended-investors">
            <Card>
              <CardHeader className="flex justify-between items-center">
